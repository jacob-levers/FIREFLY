...
class BuildMixin:
    ...
    def _build_sidebar(self, layout: QtWidgets.QVBoxLayout):
        ...
        self.c_backend.setToolTip(
            "Which detector to use for spot localisation.  Every option except\n"
            "à trous runs the SAME Crocker–Grier centroid algorithm — they differ\n"
            "only in framework / hardware.\n"
            "• Auto — recommended: PyTorch on a healthy GPU, else the parallel\n"
