...
class MainWindow(QtWidgets.QMainWindow, VisualiseMixin, CompareMixin, BatchMixin, BuildMixin, HandlersMixin):
    ...
    def _setting_specs(self):
        ...
        return [
            ...
            ("stats/nonparam",           self.c_stat_nonparam,      "combo"),
            ("stats/posthoc",            self.c_stat_posthoc,       "combo"),
            ("stats/control_group",      self.c_stat_control,       "combo"),
            ("stats/dunnett",            self.c_stat_dunnett,       "check", _bool_cast),
            ("stats/tost",               self.c_stat_tost,          "check", _bool_cast),
            ("stats/tost_margin",        self.s_stat_tost_margin,   "spin",  float),
